...
if __name__ == "__main__":
    makeCompilation(path = "/Users/chotu/Documents/automated_youtube_channel-master/Videos",
                    introName = "Intro video.mp4",
                    outroName = 'Outro video.mp4',
                    totalVidLength = 60*90,
                    maxClipLength = 90,
