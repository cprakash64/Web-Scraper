...
def scrapeVideos(username = "64memeshub",
                 password = "@Markchotugreat64",
                 output_folder = "/Users/chotu/Documents/automated_youtube_channel-master/Videos",
                 days = 1):
    ...
    for profile in following:
        ...
        looter = ProfileLooter(acc, videos_only=True, template="{id}-{username}-{width}-{height}") #here I can choose to download images also
...
if __name__ == "__main__":
    scrapeVideos(username = "64memeshub",
                 password = "@Markchotugreat64",
                 output_folder = "/Users/chotu/Documents/automated_youtube_channel-master/Videos")
