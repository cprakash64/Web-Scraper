...
print(IG_USERNAME)
print(IG_PASSWORD)
title = "Dank Memes | TRY NOT TO LAUGH | Best Memes Compilation || Compilation PUB  "
...
INTRO_VID = 'Intro video.mp4' # SET AS '' IF YOU DONT HAVE ONE
OUTRO_VID = 'Outro video.mp4'
TOTAL_VID_LENGTH = 60*90
MAX_CLIP_LENGTH = 90
MIN_CLIP_LENGTH = 5
...
def routine():
    ...
    description = "Your Daily dose of Sarcasm and Entertainment \n\n" \
     "Enjoy the memes! :) \n\n" \
    "l\LIKE and SUBSCRIBE to @Compilation PUB for more \n\n" \
